...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    private int countLooping = 0;
    private int maxCountLooping = 0;
     ...
     */
    public void startPlaying(String file, JSONObject option) {
        this.option = option;
        ...
        if (this.readyPlayer(file) && this.player != null) {
            ...
            if (option != null) {
                try {
                    this.countLooping = 0;
                    this.maxCountLooping = option.getInt("loop");
                    if (this.maxCountLooping == -1) {
                        this.player.setLooping(true);
                        this.maxCountLooping = 0;
                    }
                } catch (JSONException ignored) {
                }

                try {
                    float volume = Float.valueOf(option.getString("volume"));
    ...
    public void resumePlaying() {
        this.startPlaying(this.audioFile, null);
    }
    ...
    public void onCompletion(MediaPlayer player) {
        ...
        if (this.countLooping < this.maxCountLooping) {
            this.countLooping++;
    ...
    public void onPrepared(MediaPlayer player) {
        ...
        if (!this.prepareOnly) {
            this.startPlaying(this.audioFile, this.option);
        } else {
